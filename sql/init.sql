-- =================================================================
--  Tabla de Fundaciones (foundations)
--  Contiene información sobre las organizaciones de conservación.
-- =================================================================

-- Primero, se elimina la tabla si ya existe para evitar errores en ejecuciones repetidas.
DROP TABLE IF EXISTS foundations;

-- Se crea la tabla 'foundations' con todas sus columnas.
CREATE TABLE foundations (
    ...
    contact VARCHAR(255),
    "imageURL" VARCHAR(255), -- Las mayúsculas en nombres de columna requieren comillas dobles en PostgreSQL.
...
-- Se insertan los datos de ejemplo para las fundaciones.
...
-- Se insertan los datos de ejemplo para los animales.
